# eventFunctionsSchool_08.06.2020.R

# changes from eventFunctionsSchool_06.20.2020.R
# changed from hourly to 2-period days: in-school and out-school
...
infectionFunction <- function(
  ...
  day <- day*2 + 1 # infection starts at night so it can be detected
  if(length(nodes)>1) {
