...
bentonTest <- covidWrapper(simID=paste0(countyDT[i,(simID)],".Test"),
                   trialPop = countyDT[i,(Population)],
                   I0Pop = countyDT[i,(I0Pop)],
                   N = 500,
                   titleString = countyDT[i,(County)]
...
bentonStandard <- covidWrapper(simID=paste0(countyDT[i,(simID)],".Standard"),
                     trialPop = 65000,
